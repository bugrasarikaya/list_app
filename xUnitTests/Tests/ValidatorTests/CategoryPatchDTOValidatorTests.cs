...
namespace xUnitTests.Tests.ValidatorTests {
	public class CategoryPatchDTOValidatorTests : IClassFixture<RepositoryTestFixture> {
		[Theory]
		...
		public void Give_Invalid_Input_ShouldReturnError(string name) {
			ValidationResult dto_validation_result = new CategoryPatchDTOValidator().Validate(new CategoryPatchDTO { Name = name });
