	...
	public static class Lists {
		public static void AddLists(this ListApiDbContext context) {
			context.Lists.AddRange(
				...
				new List { ID = 5, IDCategory = 1, IDStatus = 0, IDUser = 4, Name = "Science Books", Description = "Things to reference before next Camarilla conference.", DateTimeCompleting = null, DateTimeCreating = new DateTime(2019, 04, 05), DateTimeUpdating = new DateTime(2019, 05, 06), TotalCost = 33.50 },
				new List { ID = 6, IDCategory = 3, IDStatus = 0, IDUser = 5, Name = "Clothing", Description = "I need to change my dirty clothes.", DateTimeCompleting = null, DateTimeCreating = new DateTime(1990, 03, 02), DateTimeUpdating = new DateTime(1990, 03, 03), TotalCost = 99.90 },
				new List { ID = 7, IDCategory = 2, IDStatus = 0, IDUser = 5, Name = "Cleaning", Description = "Must clean stains.", DateTimeCompleting = null, DateTimeCreating = new DateTime(1990, 03, 01), DateTimeUpdating = new DateTime(1990, 03, 02), TotalCost = 80.70 },
				new List { ID = 8, IDCategory = 5, IDStatus = 0, IDUser = 6, Name = "Gift List", Description = "Best gift for my sister.", DateTimeCompleting = null, DateTimeCreating = new DateTime(1991, 02, 01), DateTimeUpdating = new DateTime(1991, 03, 01), TotalCost = 9.99 }
			);
		}
	}
}